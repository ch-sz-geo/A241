...
4+| *Anforderungen*
m|Kennung
3+| Die Werte müssen eindeutig sein und dürfen nach der Vergabe nicht mehr geändert werden.
|===
...
m| Verfuegungslink
| https://oereblex.sz.ch/api/geolinks/@Value(`+Waldfeststellungen.Geolink_für_ÖREB+`)
m| Dokumentablage
